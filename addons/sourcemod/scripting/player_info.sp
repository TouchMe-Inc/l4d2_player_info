...
void ShowPlayersMenu(int iClient, int iSelectionPosition)
{
    ...
    Menu menu = CreateMenu(HandlerPlayerMenu, MenuAction_Select|MenuAction_Display|MenuAction_End);
...
int HandlerPlayerMenu(Menu menu, MenuAction action, int iClient, int iItem)
{
    switch (action)
    {
        case MenuAction_Display: g_iClientMenuSelectionPosition[iClient] = GetMenuSelectionPosition();
